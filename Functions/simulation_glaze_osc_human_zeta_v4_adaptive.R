simulation_glaze_osc_human_zeta_v4_adaptive <- function(n_blocks, block_length, block_probs, block_precs, var_prec,
  ...
  # Sim$oscillation_ei_LLR = -amp*(sin(frequency*(c(1:nrow(Sim))-1))) + 1
