...
add_Optim_eval = read.csv(paste("./Results/", load_idx, sep = ""))
add_Optim_eval = add_Optim_eval[add_Optim_eval$subject_id > max_number,]
Optim_eval = rbind(Optim_eval, add_Optim_eval)
max_number = max(Optim_eval$subject_id)
print(load_idx)
print(max_number)
}
Optim_eval = Optim_eval[Optim_eval$type != "fit_glaze_osc_zeta_v1_one_amp",]
unique(Optim_eval$type)
##
## mice
##
...
add_Optim_eval_mice = read.csv(paste("./Results/", load_idx, sep = ""))
add_Optim_eval_mice = add_Optim_eval_mice[add_Optim_eval_mice$subject_id > max_number,]
Optim_eval_mice = rbind(Optim_eval_mice, add_Optim_eval_mice)
max_number = max(Optim_eval_mice$subject_id)
print(load_idx)
print(max_number)
}
Optim_eval_mice = Optim_eval_mice[Optim_eval_mice$type != "fit_glaze_osc_zeta_v1_one_amp_mouse",]

write.csv(Optim_eval, "./Results/Optim_eval_human_complete.csv", row.names = FALSE)
write.csv(Optim_eval_mice, "./Results/Optim_eval_mouse_complete.csv", row.names = FALSE)
```
