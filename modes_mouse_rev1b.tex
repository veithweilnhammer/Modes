...
\(^{1}\) Department of Psychiatry, CharitC)-UniversitC$tsmedizin Berlin,
corporate member of Freie UniversitC$t Berlin and Humboldt-UniversitC$t zu
Berlin, 10117 Berlin, Germany\\
\(^{2}\) Berlin Institute of Health, CharitC)-UniversitC$tsmedizin Berlin
and Max DelbrC<ck Center, 10178 Berlin, Germany\\
\(^{3}\) Bernstein Center for Computational Neuroscience,
CharitC)-UniversitC$tsmedizin Berlin, 10117 Berlin, Germany\\
\(^{4}\) Berlin School of Mind and Brain, Humboldt-UniversitC$t zu
...
Veith Weilnhammer, Department of Psychiatry, CharitC) Campus Mitte,
CharitC)platz 1, 10117 Berlin, phone: 0049 (0)30 450 517 317, email:
...
found perception to be stimulus-congruent in 73.46\% B1 0.15\% of trials
(mean B1 standard error of the mean; Figure 2A), which was highly
...
permuted data within an interval of \(3.24\) B1
...
stimulus-congruent perception (i.e., computed in sliding windows of B1 5
trials; Figure 1C) fluctuated considerably within participants (average
minimum: 35.46\% B1 0.22\%, maximum: 98.27\% B1 0.07\%). In line with
...
\(\beta\) = \(-1.32\) B1 \(\ensuremath{3.14\times 10^{-3}}\),
...
global average of 52.7\% B1 0.12\% history-congruent trials, we found a
small but highly significant perceptual bias towards preceding
experiences (\(\beta\) = \(16.18\) B1 \(1.07\),
...
frequent at trials when perception was stimulus-incongruent (56.03\% B1
0.2\%) as opposed to stimulus-congruent (51.77\% B1 0.11\%, \(\beta\) =
\(-4.26\) B1 \(0.21\), T(\(\ensuremath{8.57\times 10^{3}}\)) =
...
of \(4.87\) B1 \(\ensuremath{3.36\times 10^{-3}}\) trials (Figure 2C),
...
windows of B1 5 trials; Figure 1C) varied considerably over time, ranging
between a minimum of 12.77\% B1 0.14\% and a maximum 92.23\% B1 0.14\%. In
...
\textasciitilde{} 1/\(f^\beta\), \(\beta\) = \(-1.34\) B1
...
vice versa, \(\beta\) = \(-0.05\) B1 \(\ensuremath{5.63\times 10^{-4}}\),
...
a squared coherence of \(6.49\) B1 \(\ensuremath{2.07\times 10^{-3}}\)\%
...
as opposed to stimulus-incongruent choices (\(\beta\) = \(-0.14\) B1
...
(\(\beta\) = \(\ensuremath{-9.56\times 10^{-3}}\) B1
...
externally-oriented perception (\(\beta_1\) = \(-11.07\) B1 \(0.55\),
...
= \(0.04\) B1 \(\ensuremath{1.18\times 10^{-3}}\),
...
history-congruence also increased confidence (\(\beta\) = \(0.48\) B1
...
externally-oriented (\(\beta_1\) = \(92.63\) B1 \(1\),
...
external mode (\(\beta_2\) = \(39.3\) B1 \(0.94\),
...
participant's M-ratio\textsuperscript{45} (meta-d'/d' = 0.85 B1 0.02) to
...
significant contribution to perception (\(\beta\) = \(0.11\) B1
\(\ensuremath{5.79\times 10^{-3}}\), z = \(18.53\), p =
\(\ensuremath{1.1\times 10^{-76}}\)) over and above the ongoing stream
of external sensory information (\(\beta\) = \(2.2\) B1
\(\ensuremath{5.87\times 10^{-3}}\), z = \(375.11\), p = \(0\)) and
general response biases toward (\(\beta\) = \(15.19\) B1 \(0.08\), z =
\(184.98\), p = \(0\)).}
...
We found perception to be stimulus-congruent in 81.37\% B1 0.3\% of
trials (Figure 3A, upper panel). In line with humans, mice were biased
toward perceptual history in 54.03\% B1 0.17\% of trials (T(164) = 23.65,
...
stimulus-incongruent (61.59\% B1 0.07\%) as opposed to stimulus-congruent
(51.81\% B1 0.02\%, T(164) = 31.37, p =
...
elevated above randomly permuted data within a lag of 4.59 B1 0.06 trials
for stimulus-congruence and 2.58 B1 0.01 trials for history-congruence
...
(\(\delta\) = \(-262.48\) B1 \(17.1\), T(164) = -15.35, p =
\(\ensuremath{1.55\times 10^{-33}}\)), while history-congruent choices
were characterized by longer TDs (\(\delta\) = \(30.47\) B1 \(5.57\),
...
\(\ensuremath{-1.97\times 10^{3}}\) B1 \(843.74\),
...
a significant effect on stimulus-congruence (\(\beta_1\) = \(-0.12\) B1
...
\(-0.03\) B1 \(\ensuremath{6.94\times 10^{-4}}\),
...
\(0.5\) B1 \(\ensuremath{1.12\times 10^{-4}}\); mice: \(\alpha\) =
\(1.06\) B1 \(\ensuremath{2.88\times 10^{-3}}\)) that captures how
strongly perception is driven by the available sensory information, and
a hazard rate parameter \(H\) (humans: \(H\) = \(0.45\) B1
\(\ensuremath{4.8\times 10^{-5}}\); mice: \(H\) = \(0.46\) B1
...
\(a_{LLR}\) = \(0.5\) B1 \(\ensuremath{2.02\times 10^{-4}}\); mice:
\(a_{LLR}\) = \(0.39\) B1 \(\ensuremath{1.08\times 10^{-3}}\)) and prior
precision (amplitude humans: \(a_{\psi}\) = \(1.44\) B1
\(\ensuremath{5.27\times 10^{-4}}\); mice: \(a_{\psi}\) = \(1.71\) B1
\(\ensuremath{7.15\times 10^{-3}}\)) fluctuated and was estimated at
\(0.11\) B1 \(\ensuremath{1.68\times 10^{-5}}\) 1/\(N_{trials}\) and
\(0.11\) B1 \(\ensuremath{1.63\times 10^{-4}}\) 1/\(N_{trials}\) in
mice.}
...
stimulus-congruent perceptual choices (humans: \(\beta\) = \(8.4\) B1
\(0.26\), T(\(\ensuremath{4.31\times 10^{3}}\)) = \(32.87\), p =
\(\ensuremath{1.3\times 10^{-211}}\); mice: \(\beta\) = \(1.93\) B1
...
(humans: \(\beta\) = \(-11.84\) B1 \(0.5\),
T(\(\ensuremath{4.29\times 10^{3}}\)) = \(-23.5\), p =
\(\ensuremath{5.16\times 10^{-115}}\); mice: \(\beta\) = \(-6.18\) B1
...
B1 \(\ensuremath{1.58\times 10^{-5}}\)); IBL
database\textsuperscript{21}: \(\hat{H}_{Mice}\) = \(0.49\) B1
...
\(\hat{H}\) for both humans (\(\beta\) = \(-6.87\) B1 \(0.94\),
T(\(61.87\)) = \(-7.33\), p = \(\ensuremath{5.76\times 10^{-10}}\)) and
mice (\(\beta\) = \(-2.91\) B1 \(0.34\), T(\(112.57\)) = \(-8.51\), p =
...
humans (\(\beta\) = \(\ensuremath{7.63\times 10^{-3}}\) B1
...
history-congruence were computed in sliding windows of B15 trials.
...
computed using a sliding windows of B15 trials (i.e., intervals
...
All aggregate data are reported and displayed with errorbars as mean B1
...
upper bound = 1; human posterior = \(0.45\) B1
\(\ensuremath{4.8\times 10^{-5}}\); mouse posterior = \(0.46\) B1
\(\ensuremath{2.97\times 10^{-4}}\)), \(\alpha\) (lower bound = 0, upper
bound = 5; human posterior = \(0.5\) B1
\(\ensuremath{1.12\times 10^{-4}}\); mouse posterior = \(1.06\) B1
\(\ensuremath{2.88\times 10^{-3}}\)), \(a_{\psi}\) (lower bound = 0,
upper bound = 10; human posterior = \(1.44\) B1
\(\ensuremath{5.27\times 10^{-4}}\); mouse posterior = \(1.71\) B1
\(\ensuremath{7.15\times 10^{-3}}\)), \(amp_{LLR}\) (lower bound = 0,
upper bound = 10; human posterior = \(0.5\) B1
\(\ensuremath{2.02\times 10^{-4}}\); mouse posterior = \(0.39\) B1
\(\ensuremath{1.08\times 10^{-3}}\)), frequency \(f\) (lower bound =
1/40, upper bound = 1/5; human posterior = \(0.11\) B1
\(\ensuremath{1.68\times 10^{-5}}\); mouse posterior = \(0.11\) B1
\(\ensuremath{1.63\times 10^{-4}}\)), \(p\) (lower bound = 0, upper
bound = \(2*\pi\); human posterior =
\(2.72 B1 \ensuremath{4.41\times 10^{-4}}\); mouse posterior = \(2.83\) B1
\(\ensuremath{3.95\times 10^{-3}}\)) and inverse decision temperature
\(\zeta\) (lower bound = 1, upper bound = 10; human posterior = \(4.63\)
B1 \(\ensuremath{1.95\times 10^{-4}}\); mouse posterior = \(4.82\) B1
...
generating stimulus-congruent choices in \(71.36\) B1
...
computed in sliding windows of B15 trials) fluctuate over time.
...
A. In humans, perception was stimulus-congruent in 73.46\% B1 0.15\% (in
red) and history-congruent in 52.7\% B1 0.12\% of trials (in blue; upper
...
history-congruence (black dotted line) amounted to \(6.49\) B1
\(\ensuremath{2.07\times 10^{-3}}\)\%

G. We observed faster RTs for both stimulus-congruence (as opposed to
stimulus-incongruence, \(\beta\) = \(-0.14\) B1
\(\ensuremath{1.6\times 10^{-3}}\),
T(\(\ensuremath{1.99\times 10^{6}}\)) = \(-85.84\), p = \(0\)) and
history-congruence (\(\beta\) = \(\ensuremath{-9.56\times 10^{-3}}\) B1
\(\ensuremath{1.37\times 10^{-3}}\),
T(\(\ensuremath{1.98\times 10^{6}}\)) = \(-6.97\), p =
...
provided by perceptual history (\(\beta_2\) = \(-19.86\) B1 \(0.52\),
T(\(\ensuremath{1.98\times 10^{6}}\)) = \(-38.43\), p =
...
stimulus-incongruence, \(\beta\) = \(0.48\) B1
\(\ensuremath{1.38\times 10^{-3}}\),
T(\(\ensuremath{2.06\times 10^{6}}\)) = \(351.54\), p = \(0\)) and
history-congruence (\(\beta\) = \(0.04\) B1
...
\(39.3\) B1 \(0.94\), T(\(\ensuremath{2.06\times 10^{6}}\)) = \(41.95\),
...
A. In mice, 81.37\% B1 0.3\% of trials were stimulus-congruent (in red)
and 54.03\% B1 0.17\% of trials were history-congruent (in blue; upper
...
autocorrelation was longer in comparison to humans (4.59 B1 0.06 on
average). For history-congruence (lower panel), the lag of positive
autocorrelation was slightly shorter relative to humans (2.58 B1 0.01 on
average, peaking at trial t+2 after the index trial).

D. In mice, the dynamic probabilities of stimulus- and
history-congruence (sliding windows of B15 trials) fluctuated as
...
F. The average squared coherence between fluctuations in stimulus- and
history-congruence (black dotted line) amounted to 3.45 B1 0.01\%.

G. We observed shorter trial durations (TDs) for stimulus-congruence (as
opposed to stimulus-incongruence, \(\beta\) = \(-1.12\) B1
\(\ensuremath{8.53\times 10^{-3}}\),
T(\(\ensuremath{1.34\times 10^{6}}\)) = \(-131.78\), p = \(0\)), but
longer TDs for history-congruence (\(\beta\) = \(0.06\) B1
...
(\(\beta_1\) = \(\ensuremath{-4.16\times 10^{4}}\) B1
...
processing and TDs (\(\beta_2\) = \(\ensuremath{-1.97\times 10^{3}}\) B1
...
A. Simulated perceptual choices were stimulus-congruent in 71.36\% B1
0.17\% (in red) and history-congruent in 51.99\% B1 0.11\% of trials (in
...
permuted data within a lag of \(2.46\) B1
\(\ensuremath{1.17\times 10^{-3}}\) trials for stimulus-congruence and
\(4.24\) B1 \(\ensuremath{1.85\times 10^{-3}}\) trials for
history-congruence.
...
1/\(f^\beta\); stimulus-congruence: \(\beta\) = \(-0.81\) B1
\(\ensuremath{1.18\times 10^{-3}}\),
T(\(\ensuremath{1.92\times 10^{5}}\)) = \(-687.58\), p = \(0\);
history-congruence: \(\beta\) = \(-0.83\) B1
...
(\(\beta\) = \(-0.03\) B1 \(\ensuremath{8.22\times 10^{-4}}\),
...
49.76\% B1 0.1\% of trials, \(\beta\) = \(1.26\) B1 \(0.94\),
T(\(373.62\)) = \(1.34\), p = \(0.18\); mice: 51.11\% B1 0.08\% of
trials, T(164) = 13.4, p = \(\ensuremath{3.86\times 10^{-28}}\)). The
bias toward stimulus history was smaller than the bias toward choice
history (humans: \(\beta\) = \(-3.53\) B1 \(0.5\), T(\(66.53\)) =
...
choice history; humans: \(\beta\) = \(0.19\) B1
\(\ensuremath{1.4\times 10^{-4}}\), z =
\(\ensuremath{1.36\times 10^{3}}\), p = \(0\): mice: \(\beta\) =
\(0.92\) B1 \(0.01\), z = \(88.82\), p = \(0\)). By contrast, perceptual
...
stimulus history; humans: \(\beta\) = \(-0.19\) B1 \(0.01\), z =
\(-16.47\), p = \(\ensuremath{5.99\times 10^{-61}}\): mice: \(\beta\) =
\(-0.92\) B1 \(0.01\), z = \(-88.76\), p = \(0\)). This repulsion of
...
outcomes in 58.71\% B1 0.22\% of trials, and mice selected the more
frequent of the two possible outcomes in 54.6\% B1 0.3\% of trials.
...
the two outcomes (humans: \(\beta\) = \(0.24\) B1
\(\ensuremath{6.93\times 10^{-4}}\),
T(\(\ensuremath{2.09\times 10^{6}}\)) = \(342.43\), p = \(0\); mice:
\(\beta\) = \(0.15\) B1 \(\ensuremath{8.25\times 10^{-4}}\),
...
dynamic probabilities in sliding windows of B1 5 trials (Figure 1C).
...
\(0.03\) B1 \(\ensuremath{7.34\times 10^{-3}}\), T(\(64.94\)) = \(4.46\),
p = \(\ensuremath{3.28\times 10^{-5}}\)), but slightly smaller in mice
(\(\beta_0\) = \(\ensuremath{-5.26\times 10^{-3}}\) B1
...
B1 \(\ensuremath{5.63\times 10^{-4}}\),
T(\(\ensuremath{2.1\times 10^{6}}\)) = \(-84.21\), p = \(0\); mice:
\(\beta_1\) = \(-0.12\) B1 \(\ensuremath{7.17\times 10^{-4}}\),
T(\(\ensuremath{1.34\times 10^{6}}\)) = \(-168.39\), p = \(0\)) beyond
the effect of ongoing changes in general response biases (humans:
\(\beta_2\) = \(-0.06\) B1 \(\ensuremath{5.82\times 10^{-4}}\),
T(\(\ensuremath{2.1\times 10^{6}}\)) = \(-103.51\), p = \(0\); mice:
\(\beta_2\) = \(-0.03\) B1 \(\ensuremath{6.94\times 10^{-4}}\),
...
biases \(\mu\) were distributed around zero (-0.05 B1 0.03; \(\beta_0\) =
\(\ensuremath{7.37\times 10^{-3}}\) B1 \(0.09\), T(\(36.8\)) = \(0.08\),
...
perceptual choice, with negative biases for \(y_{t-1} = 0\) (-0.22 B1
0.04; \(\beta_0\) = \(0.56\) B1 \(0.12\), T(\(43.39\)) = \(4.6\), p =
\(\ensuremath{3.64\times 10^{-5}}\); Supplemental Figure 6A-B, upper
panel) and positive biases for \(y_{t-1} = 1\) (0.29 B1 0.03; \(\beta_0\)
= \(0.56\) B1 \(0.12\), T(\(43.39\)) = \(4.6\), p =
\(\ensuremath{3.64\times 10^{-5}}\); Supplemental Figure 6A-B, lower
panel). Absolute biases \(|\mu|\) were larger in internal mode (1.84 B1
0.03) as compared to external mode (0.86 B1 0.02; \(\beta_0\) = \(-0.62\)
B1 \(0.07\), T(\(45.62\)) = \(-8.38\), p =
\(\ensuremath{8.59\times 10^{-11}}\); controlling for differences in
lapses and thresholds).

Lower and upper lapses amounted to \(\gamma\) = \(0.13\) B1
\(\ensuremath{2.83\times 10^{-3}}\) and \(\delta\) = \(0.1\) B1
\(\ensuremath{2.45\times 10^{-3}}\) (Supplemental Figure 6A, C and D).
Lapses were larger in internal mode (\(\gamma\) = \(0.17\) B1
\(\ensuremath{3.52\times 10^{-3}}\), \(\delta\) = \(0.14\) B1
\(\ensuremath{3.18\times 10^{-3}}\)) as compared to external mode
(\(\gamma\) = \(0.1\) B1 \(\ensuremath{2.2\times 10^{-3}}\), \(\delta\) =
\(0.08\) B1 \(\ensuremath{2\times 10^{-3}}\); \(\beta_0\) = \(-0.05\) B1
...
differed between internal and external mode (\(\beta_0\) = \(-0.1\) B1
\(\ensuremath{9.58\times 10^{-3}}\), T(\(36.87\)) = \(-10.16\), p =
\(\ensuremath{3.06\times 10^{-12}}\)), whereas lower lapses \(\gamma\)
did not (\(\beta_0\) = \(0.01\) B1 \(\ensuremath{7.77\times 10^{-3}}\),
T(\(33.1\)) = \(1.61\), p = \(0.12\)). Vice versa, for \(y_{t-1} = 1\),
lower lapses \(\gamma\) differed between internal and external mode
(\(\beta_0\) = \(-0.11\) B1 \(0.01\), T(\(40.11\)) = \(-9.59\), p =
\(\ensuremath{6.14\times 10^{-12}}\)), whereas higher lapses \(\delta\)
did not (\(\beta_0\) = \(0.01\) B1 \(\ensuremath{7.74\times 10^{-3}}\),
T(\(33.66\)) = \(1.58\), p = \(0.12\)).

Thresholds \(t\) were estimated at 3 B1 0.06 (Supplemental Figure 6A and
E). Thresholds \(t\) were larger in internal mode (3.66 B1 0.09) as
compared to external mode (2.02 B1 0.03; \(\beta_0\) = \(-1.77\) B1
\(0.25\), T(\(50.45\)) = \(-7.14\), p =
...
perceptual history (\(\beta_0\) = \(0.04\) B1 \(0.06\),
...
zero (\(\ensuremath{3.87\times 10^{-3}}\) B1
...
(\(-0.02\) B1 \(\ensuremath{8.7\times 10^{-3}}\); T(\(164) = -1.99\), p =
\(0.05\); Supplemental Figure 7A-B, middle panel) and positive for
\(y_{t-1} = 1\) (\(0.02\) B1 \(\ensuremath{9.63\times 10^{-3}}\);
T(\(164\)) = \(1.91\), p = \(0.06\); Supplemental Figure 7A-B, lower
panel). As in humans, mice showed larger biases during internal mode
(\(0.14\) B1 \(\ensuremath{7.96\times 10^{-3}}\)) as compared to external
mode (\(0.07\) B1 \(\ensuremath{8.7\times 10^{-3}}\); \(\beta_0\) =
\(-0.18\) B1 \(0.03\), T = \(-6.38\), p =
\(\ensuremath{1.77\times 10^{-9}}\); controlling for differences in
lapses and thresholds).

Lower and upper lapses amounted to \(\gamma\) = \(0.1\) B1
\(\ensuremath{4.35\times 10^{-3}}\) and \(\delta\) = \(0.11\) B1
\(\ensuremath{4.65\times 10^{-3}}\) (Supplemental Figure 7A, C and D).
Lapse rates were higher in internal mode (\(\gamma\) = \(0.15\) B1
\(\ensuremath{5.14\times 10^{-3}}\), \(\delta\) = \(0.16\) B1
\(\ensuremath{5.79\times 10^{-3}}\)) as compared to external mode
(\(\gamma\) = \(0.06\) B1 \(\ensuremath{3.11\times 10^{-3}}\), \(\delta\)
= \(0.07\) B1 \(\ensuremath{3.34\times 10^{-3}}\); \(\beta_0\) =
\(-0.11\) B1 \(\ensuremath{4.39\times 10^{-3}}\), T = \(-24.8\), p =
...
In mice, thresholds \(t\) amounted to \(0.15\) B1
\(\ensuremath{6.52\times 10^{-3}}\) (Supplemental Figure 7A and E) and
were higher in internal mode (\(0.27\) B1 \(0.01\)) as compared to
external mode (\(0.09\) B1 \(\ensuremath{4.44\times 10^{-3}}\);
\(\beta_0\) = \(-0.28\) B1 \(0.04\), T = \(-7.26\), p =
...
(\(\beta\) = \(\ensuremath{-7.53\times 10^{-5}}\) B1
...
\(\ensuremath{3.6\times 10^{-5}}\) B1
\(\ensuremath{2.54\times 10^{-6}}\), z = \(14.19\), p =
\(\ensuremath{10^{-45}}\)) and a decrease in TDs (\(\beta\) = \(-0.1\) B1
...
A. Stimulus-congruent choices in humans amounted to 73.46\% B1 0.15\% of
trials and were highly consistent across the experiments selected from
the Confidence Database.

B. History-congruent choices in humans amounted to 52.7\% B1 0.12\% of
...
autocorrelation of randomly permuted within a lag of \(21.66\) B1
...
within a lag of \(2.94\) B1 \(\ensuremath{4.4\times 10^{-3}}\)
...
permuted data within a lag of 15.13 B1 0.19 consecutive trials (lower
panel).
...
lag of \(2.53\) B1 \(\ensuremath{9.8\times 10^{-3}}\) consecutive trials
(lower panel).
...
regression coefficients (depicted as mean B1 SEM, dots mark trials with
...
contributed significantly to perception (difference in AIC = 8.07 B1
0.53, T(\(57.22\)) = \(4.1\), p = \(\ensuremath{1.31\times 10^{-4}}\)).

B. Participant-wise regression coefficients amount to 0.18 B1 0.02 for
the effect of perceptual history and 2.51 B1 0.03 for external sensory
stimulation.
...
and the preceding percept (difference in AIC = 88.62 B1 8.57, T(\(164\))
= \(-10.34\), p = \(\ensuremath{1.29\times 10^{-19}}\)).

D. In mice, individual regression coefficients amounted to 0.42 B1 0.02
for the effect of perceptual history and 6.91 B1 0.21 for external
sensory stimulation.
...
data at a level of 58.71\% B1 0.22\% in humans and 54.6\% B1 0.3\% in
mice.
...
(\(\beta_0\) = \(-0.11\) B1 \(\ensuremath{4.39\times 10^{-3}}\), T =
...
to the second-best model M2 in humans: \(\beta\) = \(-1.81\) B1 \(0.27\),
...
perceptual choices were stimulus-congruent in 71.97\% B1 0.17\% of trials
(in red). History-congruent amounted to 50.76\% B1 0.07\% of trials (in
...
of stimulus- and history-congruence (sliding windows of B15 trials)
...
\(\beta\) = \(-0.81\) B1 \(\ensuremath{1.17\times 10^{-3}}\),
T(\(\ensuremath{1.92\times 10^{5}}\)) = \(-688.65\), p = \(0\);
history-congruence: \(\beta\) = \(-0.79\) B1
...
\(\ensuremath{2.7\times 10^{-3}}\) B1 \(\ensuremath{7.6\times 10^{-4}}\),
...
\(\ensuremath{5.27\times 10^{-6}}\)) and amounted to 3.43 B1
...
\(0.34\) B1 \(0.1\), T(\(\ensuremath{2.1\times 10^{6}}\)) = \(3.49\), p =
...
perceptual choices were stimulus-congruent in 71.97\% B1 0.17\% of trials
(in red). History-congruent amounted to 52.1\% B1 0.11\% of trials (in
...
to stimulus-congruence relative to the full model (1.8 B1
...
model with respect to history-congruence (4.25 B1
...
stimulus- and history-congruence (sliding windows of B15 trials)
fluctuated as \textbf{a scale-invariant process with a 1/f power law},
i.e., at power densities that were inversely proportional to the
frequency (power \textasciitilde{} 1/\(f^\beta\); stimulus-congruence:
\(\beta\) = \(-0.78\) B1 \(\ensuremath{1.11\times 10^{-3}}\),
...
history-congruence were anti-correlated (\(\beta\) = \(-0.03\) B1
...
A. Similar to the full model (Figure 1F and Figure 4), simulated
perceptual choices were stimulus-congruent in 71.97\% B1 0.17\% of trials
(in red). History-congruent amounted to 50.73\% B1 0.07\% of trials (in
...
with respect to both stimulus-congruence (1.8 B1
\ensuremath{1.59\times 10^{-3}} trials;
T(\ensuremath{4.31\times 10^{3}}) = -5.21, p =
\(\ensuremath{2\times 10^{-7}}\)) and history-congruence (2.18 B1
...
probabilities of stimulus- and history-congruence (sliding windows of B15
...
frequency (power \textasciitilde{} 1/\(f^\beta\); stimulus-congruence:
\(\beta\) = \(-0.78\) B1 \(\ensuremath{1.1\times 10^{-3}}\),
...
(\(\beta\) = \(\ensuremath{4.3\times 10^{-3}}\) B1
...
relationship between the mode of perceptual processing and confidence
was markedly reduced in comparison to the full model (\(\beta_2\) =
\(0.14\) B1 \(0.07\), T(\(\ensuremath{2.1\times 10^{6}}\)) = \(1.95\), p
...
A. Similar to the full model (Figure 1F and Figure 4), simulated
perceptual choices were stimulus-congruent in 72.14\% B1 0.17\% of trials
(in red). History-congruent amounted to 49.89\% B1 0.03\% of trials (in
...
respect to stimulus-congruence (2.83 B1 \ensuremath{1.49\times 10^{-3}}
trials; T(\ensuremath{4.31\times 10^{3}}) = 3.45, p =
\(\ensuremath{5.73\times 10^{-4}}\)) and decreased with respect to
history-congruence (1.85 B1 \ensuremath{3.49\times 10^{-4}} trials;
...
i.e., at power densities that were inversely proportional to the
frequency (power \textasciitilde{} 1/\(f^\beta\); stimulus-congruence:
\(\beta\) = \(-0.82\) B1 \(\ensuremath{1.2\times 10^{-3}}\),
T(\(\ensuremath{1.92\times 10^{5}}\)) = \(-681.98\), p = \(0\);
history-congruence: \(\beta\) = \(-0.78\) B1
...
\(\ensuremath{4.63\times 10^{-23}}\)) and amounted to 2.8 B1
\ensuremath{7.29\times 10^{-4}}\%.

G. Similar to the full bimodal inference model, confidence simulated
from the no-evidence-accumulation model was enhanced for
stimulus-congruent choices (\(\beta\) = \(0.01\) B1
...
relationship between the mode of perceptual processing and confidence
was markedly reduced in comparison to the full model (\(\beta_2\) =
\(0.19\) B1 \(0.06\), T(\(\ensuremath{2.11\times 10^{6}}\)) = \(3\), p =
...
\textbf{Note that I am reading the parameters omega\_LLR and omega\_O as
...
\item
  ...
  at which likelihood (amplitude humans: \(a_{LLR}\) = \(0.5\) B1
  \(\ensuremath{2.02\times 10^{-4}}\); mice: \(a_{LLR}\) = \(0.39\) B1
  \(\ensuremath{1.08\times 10^{-3}}\) and prior precision (amplitude
  humans: \(a_{\psi}\) = \(1.44\) B1 \(\ensuremath{5.27\times 10^{-4}}\);
  mice: \(a_{\psi}\) = \(1.71 B1 \ensuremath{7.15\times 10^{-3}}\) were
  shifted against each other and was estimated at \(0.11\) B1
  \(\ensuremath{1.68\times 10^{-5}}\) 1/\(N_{trials}\) and
  \(0.11 B1 \ensuremath{1.63\times 10^{-4}}\) 1/\(N_{trials}\) in mice.}
\item
...
\textbf{Note, again, I am reading your omega\_LLR and omega\_O as
...
\item
  ...
  in \(71.36\) B1 \(\ensuremath{2.6\times 10^{-3}}\)\% of trials. Choices
...
\item
  ...
  and a hazard rate parameter \(H\) (humans: \(H\) = \(0.45\) B1
  \(\ensuremath{4.8\times 10^{-5}}\); mice: \(H\) = \(0.46\) B1
  \(\ensuremath{2.97\times 10^{-4}}\)) that controls how heavily
  perception is biased by perceptual history. The parameter \(f\)
  captures the dominant time scale at which likelihood (amplitude
  humans: \(a_{LLR}\) = \(0.5\) B1 \(\ensuremath{2.02\times 10^{-4}}\);
  mice: \(a_{LLR}\) = \(0.39\) B1 \(\ensuremath{1.08\times 10^{-3}}\))
  and prior precision (amplitude humans: \(a_{\psi}\) = \(1.44\) B1
  \(\ensuremath{5.27\times 10^{-4}}\); mice: \(a_{\psi}\) = \(1.71\) B1
  \(\ensuremath{7.15\times 10^{-3}}\)) fluctuated and was estimated at
  \(0.11\) B1 \(\ensuremath{1.68\times 10^{-5}}\) 1/\(N_{trials}\) and
  \(0.11\) B1 \(\ensuremath{1.63\times 10^{-4}}\) 1/\(N_{trials}\) in
...
\item
  ...
  \(\hat{H}_{Humans}\) = 0.5 B1 \ensuremath{1.58\times 10^{-5}}); IBL
  database\textsuperscript{21}: \(\hat{H}_{Mice}\) = 0.49 B1
  \ensuremath{6.47\times 10^{-5}}). Indeed, when fitting the bimodal
  ...
  and mice (\(\beta\) = \(-2.91\) B1 \(0.34\), T(\(112.57\)) = \(-8.51\),
...
\item
  ...
  in humans (\(\beta\) = \(\ensuremath{-4.36\times 10^{-3}}\) B1
  \(\ensuremath{4.64\times 10^{-4}}\),
  T(\(\ensuremath{1.98\times 10^{6}}\)) = \(-9.41\), p =
  \(\ensuremath{5.19\times 10^{-21}}\)) and TDs mice (\(\beta\) =
  \(-35.45\) B1 \(0.86\), T(\(\ensuremath{1.28\times 10^{6}}\)) =
  ...
  in humans (\(\beta\) = \(\ensuremath{7.63\times 10^{-3}}\) B1
  \(\ensuremath{8.32\times 10^{-4}}\),
  T(\(\ensuremath{2.06\times 10^{6}}\)) = \(9.18\), p =
  \(\ensuremath{4.48\times 10^{-20}}\)).}
\item
  ...
  \(\ensuremath{8.22\times 10^{-3}}\) B1
  \(\ensuremath{1.94\times 10^{-3}}\), z = \(4.25\), p =
  \(\ensuremath{2.17\times 10^{-5}}\); mice: \(\beta\) =
  \(\ensuremath{-3.72\times 10^{-3}}\) B1
  \(\ensuremath{1.83\times 10^{-3}}\), z = \(-2.03\), p = \(0.04\)) and
  subjective confidence (humans: \(\beta\) = \(0.04\) B1
...
\item
  ...
  \(-1.81\) B1 \(0.27\), T(\(\ensuremath{5.07\times 10^{3}}\)) =
...
(omega\_LLR) and prior (omega\_O) that constitute the log posterior.}
...
\item
  ...
  (\(\beta\) = \(0.11\) B1 \(\ensuremath{5.79\times 10^{-3}}\), z =
  \(18.53\), p = \(\ensuremath{1.1\times 10^{-76}}\)) over and above the
  ongoing stream of external sensory information (\(\beta\) = \(2.2\) B1
  \(\ensuremath{5.87\times 10^{-3}}\), z = \(375.11\), p = \(0\)) and
  general response biases toward (\(\beta\) = \(15.19\) B1 \(0.08\), z =
...
\item
  ...
  from perceptual history (and vice versa, \(\beta\) = \(-0.05\) B1
  \(\ensuremath{5.63\times 10^{-4}}\),
  T(\(\ensuremath{2.1\times 10^{6}}\)) = \(-84.21\), p = \(0\)),
  controlling for fluctuations in the strength of general response
  biases (\(\beta\) = \(-0.06\) B1 \(\ensuremath{5.82\times 10^{-4}}\),
...
\item
  **As in humans, fluctuations in the strength of history-congruent
  ...
  \(-0.12\) B1 \(\ensuremath{7.17\times 10^{-4}}\),
  T(\(\ensuremath{1.34\times 10^{6}}\)) = \(-168.39\), p = \(0\)) beyond
  the effect of ongoing changes in general response biases (\(\beta_2\)
  = \(-0.03\) B1 \(\ensuremath{6.94\times 10^{-4}}\),
  T(\(\ensuremath{1.34\times 10^{6}}\)) = \(-48.14\), p = \(0\)).
...
\item
  ...
  (humans: 49.76\% B1 0.1\% of trials, \(\beta\) = \(1.26\) B1 \(0.94\),
  T(\(373.62\)) = \(1.34\), p = \(0.18\); mice: 51.11\% B1 0.08\% of
  trials, T(164) = 13.4, p = \(\ensuremath{3.86\times 10^{-28}}\)). The
  bias toward stimulus history was smaller than the bias toward choice
  history (humans: \(\beta\) = \(-3.53\) B1 \(0.5\), T(\(66.53\)) =
...
\item
  ...
  positive effect of choice history; humans: \(\beta\) = \(0.19\) B1
  \(\ensuremath{1.4\times 10^{-4}}\), z =
  \(\ensuremath{1.36\times 10^{3}}\), p = \(0\): mice: \(\beta\) =
  \(0.92\) B1 \(0.01\), z = \(88.82\), p = \(0\)). By contrast,
  ...
  effect of stimulus history; humans: \(\beta\) = \(-0.19\) B1 \(0.01\),
  z = \(-16.47\), p = \(\ensuremath{5.99\times 10^{-61}}\): mice:
  \(\beta\) = \(-0.92\) B1 \(0.01\), z = \(-88.76\), p = \(0\)). This
...
\item
  ...
  \(-0.05\) B1 \(\ensuremath{5.63\times 10^{-4}}\),
  T(\(\ensuremath{2.1\times 10^{6}}\)) = \(-84.21\), p = \(0\),
...
\item
  ...
  significant effect on stimulus-congruence (\(\beta_1\) = \(-0.12\) B1
  \(\ensuremath{7.17\times 10^{-4}}\),
  T(\(\ensuremath{1.34\times 10^{6}}\)) = \(-168.39\), p = \(0\)) beyond
  the effect of ongoing changes in general response biases (\(\beta_2\)
  = \(-0.03\) B1 \(\ensuremath{6.94\times 10^{-4}}\),
...
of 1/fN1 noise in human cognition}. \emph{Psychonomic Bulletin and
