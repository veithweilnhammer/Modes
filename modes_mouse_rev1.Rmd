...
Exp_rep$RT_type = "?"
Exp_rep$Difficulty_Manipulation = ?
...
RTs were available for `r sum(Exp_rep$RT_available)` out of the `r nrow(Exp_rep)` experiments investigated here. Within the  `r sum(Exp_rep$RT_available)` experiments
